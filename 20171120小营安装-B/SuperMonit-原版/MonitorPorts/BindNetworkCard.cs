...
namespace MonitorPorts
{
    class BindNetworkCard
    {
        ...
        public BindNetworkCard()
        {
            ...
            {
                Bind(LocalNetwork[0]);
                SaveNetnumToTxt(LocalNetwork[0]);
            }
            else
            {
                ...
                if (Warn.ShowDialog() == DialogResult.OK)
                {
                    ...
                    SaveNetnumToTxt(Warning.SelectedNetCard);
                }
            }
        }

        private void SaveNetnumToTxt(string msg)
        {
            FileStream fs = new FileStream("BindNetcard.txt", FileMode.Create, FileAccess.Write);
